package com.creativetrends.simplicity.app.behavior;
 ...
 */
public class BottomBehavior<V extends View> extends VerticalScrollingBehavior<V> {
	...
	public static boolean behaviorTranslationEnabled = false;

	public BottomBehavior() {
		super();
	}

	public BottomBehavior(boolean behaviorTranslationEnabled) {
		super();
		BottomBehavior.behaviorTranslationEnabled = behaviorTranslationEnabled;
	}
	...
	public static <V extends View> BottomBehavior<V> from(V view) {
		...
		return (BottomBehavior<V>) behavior;
	}
