...
public class FileTypeUtils {
    public enum FileType {
        ...
        DEB(R.drawable.ic_deb, R.string.type_deb, "deb"),
        CERTIFICATE(R.drawable.ic_certif, R.string.type_certificate, "cer", "der", "pfx", "p12", "arm", "pem"),
        ...
        MUSIC(R.drawable.ic_music, R.string.type_music, "aiff", "aif", "wav", "flac", "m4a", "wma", "amr", "mp2", "mp3", "wma", "aac", "mid", "m3u", "ogg"),
        ...
        WEB(R.drawable.ic_web, R.string.type_web, "html", "htm", "mth"),
        WORD(R.drawable.ic_word, R.string.type_word, "doc", "docm", "docx", "dot", "mcw", "rtf", "pages", "odt", "ott"),
        APK(R.drawable.ic_apk, R.string.type_apk, "apk", "aab"),
        ARCHIVE(R.drawable.ic_zip, R.string.type_archive, "cab", "7z", "alz", "arj", "bzip2", "bz2", "dmg", "gzip", "gz", "jar", "lz", "lzip", "lzma", "zip", "rar", "tar", "tgz"),;
