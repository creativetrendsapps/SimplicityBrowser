...
public class CustomBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public static boolean FABbehavior = false;

    public CustomBehavior() {
        super();
    }

    public CustomBehavior(boolean FABbehavior) {
        super();
        CustomBehavior.FABbehavior = FABbehavior;
    }
    ...
    public static <V extends View> CustomBehavior<V> from(V view) {
        ...
        if (!(behavior instanceof CustomBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with CustomBehavior");
        }
        return (CustomBehavior<V>) behavior;
    }
